...
## كيفية البدء (Installation)

أولاً، قم بتحميل المشروع من GitHub:
```bash
git clone https://github.com/s8kun/Supply_company_System.git
cd Supply_company_System
```

---

## التشغيل باستخدام Docker (الخيار الأسرع)
هذا هو الخيار الموصى به لتشغيل المشروع فوراً دون الحاجة لتثبيت أي برامج إضافية على جهازك.
...
- سيقوم Docker تلقائياً بضبط قاعدة البيانات وتثبيت المكتبات وملء البيانات (Seed).
